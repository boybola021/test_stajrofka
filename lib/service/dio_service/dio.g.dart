...
class _DioNetwork implements DioNetwork {
  _DioNetwork(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<DataResponse> postSignUp(UserModel userModel) async {
  ...
  @override
  Future<bool> postAdd({required LocationModel postAdd}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
